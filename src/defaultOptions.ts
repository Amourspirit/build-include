// #region imports
import { IBiGruntOpt, IMatchOpt, IBuildIncludeOpt, IGruntOptFence, ILogger } from "./build-incude/interfaces";
// import * as mo from './matchOptions';
import { MatchBuildInclude } from "./build-incude/matches/MatchBuildInclude";
import { MatchBuildIncludeHtml } from "./build-incude/matches/MatchBuildIncludeHtml";
import { MatchBuildIncludePound } from "./build-incude/matches/MatchBuildIncludePound";
import { MatchBuildIncludeSlash } from "./build-incude/matches/MatchBuildIncludeSlash";
import { MatchBracketInclude } from "./build-incude/matches/MatchBracketInclude";
import { MatchBracketIncludeMulti } from "./build-incude/matches/MatchBracketIncludeMulti";
import { regexKind, commentKind, fenceKind, whiteSpLn } from './build-incude/enums';
// import * as grunt from './build-incude/node_modules/grunt';
import { splitByOpt, lnEndOpt, widthFlags } from 'string-breaker';
import { eKind } from './build-incude/enumEKind';
import { eProcess } from './build-incude/enumEProcess';
import { Util } from './build-incude/util';
import { StrictFence } from "./build-incude/fences/StrictFence";
import { FlexFence } from "./build-incude/fences/FlexFence";
 ...
 */
export const setMatchOptions = (options: IBiGruntOpt, logger: ILogger): void => {
