import { MatchBuildIncludeQuote } from "../MatchBuildIncludeQuote";
import { MatchOptionsProcess } from "../../process/MatchOptionsProcess";
const inst = new MatchBuildIncludeQuote();
...
describe('Test Properties', () => {
  ...
  test('kind', (done) => {
    expect.assertions(1);
    expect(inst.kind).toBe('buildIncludeQuote');
    done();
  });
